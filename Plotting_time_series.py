...
three_month_high_RP_date_lst = list(Neste_and_SXXP_HIGH_DATA_df['Date'])
three_month_high_RP_lst = list(Neste_and_SXXP_HIGH_DATA_df['RP_3_month_high'])
...
RP_3_month_high_rolling, = ax.plot(date_lst, rolling_3_month_high_RP_lst, label = 'RP Rolling 3-month High')
...
RP_3_month_high, = ax.plot(three_month_high_RP_date_lst, three_month_high_RP_lst, label = 'RP 3-month High')
...
RP_leg, RP_3_month_high_rolling_leg, RP_1_month_after_3_month_high_leg, RP_3_month_after_3_month_high_leg, RP_6_month_after_3_month_high_leg, RP_3_month_high_leg = legend.get_lines()

RP_leg.set_picker(True)
RP_leg.set_pickradius(10)

RP_3_month_high_rolling_leg.set_picker(True)
RP_3_month_high_rolling_leg.set_pickradius(10)
...
graphs_dict[RP_3_month_high_rolling_leg] = RP_3_month_high_rolling
...
# plt.savefig('Plot_examples/Time_Series_Data_example.png', dpi = 800)
